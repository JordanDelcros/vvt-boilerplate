...
export default async function packModel( source ){

	console.log(`🪩 pack-model "${ source.file }"`);
	...
	// Disable double sided (default true)
	if( source.options.forceSingleSide !== false ){
